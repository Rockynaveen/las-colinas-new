...
import { ArrowUp, Send, Check, MapPin } from 'lucide-react';
...
export const Footer: React.FC = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      description: 'Maximizing operate models and yields.',
        ...
        <div className="footer-links-grid">
          ...
          <div className="footer-links-column contact-column">
            ...
            <p className="footer-contact-info">
              Las Colinas Hospitality Management<br />
              450 E. John Carpenter Freeway<br />
              Irving, Texas 75062
            </p>
            <p className="footer-contact-info" style={{ marginTop: '0.5rem' }}>
              <a href="tel:214-729-9676" className="footer-contact-link">214-729-9676</a><br />
              <a href="tel:214-709-4231" className="footer-contact-link">214-709-4231</a><br />
              <a href="mailto:info@lascolinasmanagement.com" className="footer-contact-link">info@lascolinasmanagement.com</a>
            </p>
          </div>
        </div>

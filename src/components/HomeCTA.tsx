...
export const HomeCTA: React.FC<HomeCTAProps> = ({ isHome2 }) => {
  return (
    <section className={`home-cta-section ${isHome2 ? 'home2-cta-section' : ''}`}>
      <div className="home-cta-container">
        <motion.div 
          className={`cta-banner-panel ${isHome2 ? 'home2-cta-panel' : ''}`}
        ...
        >
          ...
          <div className="cta-banner-grid">
            ...
            {/* Right Column: Masked Image & Logo Overlay (Omitted in Home 2) */}
            {!isHome2 && (
              <div className="cta-right-column">
                <div className="cta-image-wrapper">
                  <img 
                    src="/home-page-cta.webp" 
                    alt="Las Colinas Luxury Property & Dallas Skyline at Sunset" 
